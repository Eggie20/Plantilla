            ...
            <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                        ...
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(url('/login')); ?>" class="space-y-4" id="loginForm">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="redirect_to" value="<?php echo e(url('/index')); ?>">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       maxlength="50"
                                       pattern="[a-zA-Z0-9_.\-]+"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm <?php $__errorArgs = ['username'];
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" 
                                           ...
                                           required 
                                           minlength="6"
                                           class="mt-1 block w-full pr-10 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php /**PATH C:\xampp\htdocs\plantilla versions\plantilla v1.9 - Copy\resources\views/auth/loginModal.blade.php ENDPATH**/ ?>