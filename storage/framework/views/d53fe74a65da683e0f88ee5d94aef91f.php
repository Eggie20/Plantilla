<?php $__env->startSection('title', 'Municipality of Magallanes - Vacant Positions'); ?>

<?php $__env->startPush('styles'); ?>
<link rel="stylesheet" href="/css/Plantilla/vacant/vacant.css">
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
<meta name="user-permissions" content="<?php echo e(json_encode(auth()->user()->permissions)); ?>">
<style>
    .invalid-feedback {
        display: block;
    }
        ...
        <div class="col-12" style="max-width: 1400px;">
            <div class="card shadow-sm mx-auto p-3 card-custom-padding">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <?php if(in_array('edit', auth()->user()->permissions) || in_array('create', auth()->user()->permissions)): ?>
                    <div>
...
<div class="modal fade" id="positionModal" tabindex="-1" aria-labelledby="positionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="positionForm" action="<?php echo e(route('position.store')); ?>" method="POST" novalidate>
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="assignPersonnelModal" tabindex="-1" aria-labelledby="assignPersonnelModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="assignPersonnelForm" method="POST" action="<?php echo e(route('personnel.assign')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="deletePositionForm" action="<?php echo e(route('position.delete', 'id')); ?>" method="POST" class="d-none">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/Plantilla/vacant/vacant.js')); ?>"></script>
    <script src="<?php echo e(asset('js/Plantilla/vacant/position.js')); ?>"></script>
    <script src="<?php echo e(asset('js/Plantilla/vacant/assign.js')); ?>"></script>
    <script src="<?php echo e(asset('js/Plantilla/vacant/offices/offices.js')); ?>"></script>
    <script src="<?php echo e(asset('js/Plantilla/vacant/offices/add-office.js')); ?>"></script>
    <script src="<?php echo e(asset('js/Plantilla/vacant/assigned.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('Plantilla.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plantilla versions\plantilla v1.9 - Copy\resources\views/Plantilla/Pages/vacant.blade.php ENDPATH**/ ?>