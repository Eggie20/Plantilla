...
<head>
    ...
    <title>Municipality of Magallanes - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?>
    <?php echo $__env->make('auth.loginModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <a href="<?php echo e(route('index')); ?>" class="sidebar-brand">
    ...
    <div class="sidebar-menu">
        ...
        <ul class="list-unstyled">
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('index') ? 'active' : ''); ?>">
        ...
        <ul class="list-unstyled">
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('Plantilla.Pages.vacant')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('Plantilla.Pages.vacant') ? 'active' : ''); ?>">
                    <div class="sidebar-menu-icon">
            ...
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('Plantilla.Pages.YearsOfService')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('Plantilla.Pages.YearsOfService') ? 'active' : ''); ?>">
                    <div class="sidebar-menu-icon">
...
<!-- <li class="sidebar-menu-item">
    <a href="#" class="sidebar-menu-link">
        ...
        <span class="sidebar-menu-text">NOSA</span>
            ...
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('Plantilla.Pages.Remarks')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('Plantilla.Pages.Remarks') ? 'active' : ''); ?>">
                    <div class="sidebar-menu-icon">
        ...
        <ul class="list-unstyled">
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('Plantilla.Pages.Accounts')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('Plantilla.Pages.Accounts') ? 'active' : ''); ?>">
                    <div class="sidebar-menu-icon">
            ...
            <?php if(Auth::user()->role === 'superadmin'): ?>
                <!-- Auth Logs Link -->
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('admin.authlogs.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.authlogs.index') ? 'active' : ''); ?>">
                        <div class="sidebar-menu-icon">
                ...
                <!-- Activity Log Link -->
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('activity.log')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('activity.log') ? 'active' : ''); ?>">
                        <div class="sidebar-menu-icon">
...
</html><?php /**PATH C:\xampp\htdocs\plantilla versions\plantilla v1.9 - Copy\resources\views/Plantilla/sidebar.blade.php ENDPATH**/ ?>