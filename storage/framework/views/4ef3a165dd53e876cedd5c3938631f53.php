...
<?php $__env->startSection('title', 'Retirement Remarks'); ?>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $personnels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personnel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <tr class="<?php echo e(getRetirementStatus($personnel)); ?>" data-personnel-id="<?php echo e($personnel->id); ?>">
                                <td><?php echo e($personnel->lastName); ?>, <?php echo e($personnel->firstName); ?> <?php echo e($personnel->middleName); ?></td>
                                <td><?php echo e($age); ?></td>
                                <td><?php echo e($dob->format('F j, Y')); ?></td>
                                <td><?php echo e($personnel->position); ?></td>
                                <td class="office-name"><?php echo e($officeName); ?></td>
                                <td>
                                    <?php if($hasPendingRetirement): ?>
                                        <button class="pending-button" onclick="viewPendingRetirement(<?php echo e($personnel->id); ?>)">
                                            View Pending
                                        </button>
                                    <?php elseif($isRetirable): ?>
                                        <button class="retire-button" onclick="showRetirementModal(<?php echo e($personnel->id); ?>, '<?php echo e($personnel->lastName); ?>, <?php echo e($personnel->firstName); ?> <?php echo e($personnel->middleName); ?>', '<?php echo e($age); ?>', '<?php echo e($dob->format('F j, Y')); ?>', '<?php echo e($personnel->originalAppointment->format('F j, Y')); ?>')">
                                            Retire
                                        </button>
                                    <?php endif; ?>
                                </td>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        async function submitRetirementForm() {
            ...
            try {
                const response = await fetch(`<?php echo e(url('/retire-personnel')); ?>`, {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('Plantilla.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plantilla versions\plantilla v1.9 - Copy\resources\views/Plantilla/Pages/Remarks.blade.php ENDPATH**/ ?>