...
<div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="addUserForm" action="<?php echo e(route('user.store')); ?>" method="POST" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
                <?php if($errors->any()): ?>
...
<div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="editUserForm" action="<?php echo e(route('user.update')); ?>" method="POST" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
        ...
        document.querySelectorAll('.block-user-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('confirmBlock').addEventListener('click', function() {
                    ...
                    fetch('<?php echo e(route('auth.block')); ?>', {
                        method: 'POST',
                        body: formData,
                        headers: {
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
</script><?php /**PATH C:\xampp\htdocs\plantilla versions\plantilla v1.9 - Copy\resources\views/Plantilla/Modal/user/userModal.blade.php ENDPATH**/ ?>